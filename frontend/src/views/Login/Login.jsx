...
export default function Login() {
  ...
  //Redirect logic: redirect the user to the page they originally came from — otherwise send them to /
  ...
  const onSubmit = async (data) => {
    setLoading(true);
    setApiErrors([]); // clear previous backend errors
    setMessage(null);
        ...
        <div className="col-md-6 col-lg-5">
          <div className="login-card card shadow">
            <div className="card-body p-4">
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate> {/*disable the browser’s built-in HTML validation*/}
                {/* email*/}
                <div className="mb-3">
                ...
                <button
                  ...
                  disabled={loading || !isValid} // keep button disabled if form invalid
                >
