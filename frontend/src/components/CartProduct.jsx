...
const CartProduct = ({ item: product }) => {
  ...
  // 🔹 Use stock property from cart context
  const maxStock = product.stock ?? 0;
  ...
  const handleInputChange = (e) => {
    ...
    console.log("[CartProduct] Input change:", {
        ...
        <div className="quantity-controls-wrapper">
          <div className="quantity-controls">
            ...
            <button
              ...
              disabled={isOutOfStock} // ✅ Disabled if no stock
            >
              −
            </button>
            ...
            <button
              ...
              disabled={isOutOfStock || product.quantity >= maxStock} // ✅ Disabled at limit
            >
              +
            </button>
